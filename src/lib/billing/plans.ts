...
export const PLANS: Record<PlanId, Plan> = {
  ...
  pro: {
    ...
    description:
      'Full Mission Control. Deploy-button agents, unlimited projects, and cloud features.',
    badge: 'Most Popular',
    features: [
      { name: 'Everything in Free', included: true },
      { name: 'BYOG or one-click deploy Gateway', included: true },
